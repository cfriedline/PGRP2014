...
portrait, margin=0mm, innermargin=15mm,
blockverticalspace=14mm, colspace=14mm,
...
\begin{columns}
  ...
  \block{Objectives}{
    ...
    \item Field sampling: needle collection, bark thickness,
      DBH, height, GPS
    \item DNA library preparation \citep{Parchman:MolEcol:2012,Peterson:PlosOne:2012}
  ...
  \block{Project status}{
    \begin{tikzfigure}
      \includegraphics[width=0.40\textwidth]{map.png} 
    \end{tikzfigure}
     \begin{center}
  ...
  \block{Conclusions} {
    \begin{itemize}\Large
    \item There is evidence of local adaptation in the bark thickness
      phenotype\\(Table 2).
    \item Environmental correlations present but may suffer from
      sampling or other bias (Table 3).
    \item Though climate is structured spatially, the phenotype
      appears not to be (Table 3).
    \end{itemize}
  }
