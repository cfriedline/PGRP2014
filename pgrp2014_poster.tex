...
\begin{columns}
  ...
  \innerblock[]{}{
      ...
      \begin{tabular}{lrrrr}
        \toprule
        Species & N & Pops & Mean DBH (cm) & Mean Height (m) \\
        \midrule
        \textit{P.\ elliotti} & 55 & 3 & 39.5 (10.0) & 24.8 (5.1) \\ 
        \textit{P.\ palustris} & 297 & 18 &  44.2 (8.2) & 22.9 (4.2) \\
        \textit{P.\ serotina} & 23 & 1 & 29.4 (7.8) & 20.2 (6.2) \\
        \textit{P.\ taeda} & 370 & 21 & 47.5 (12.9) & 27.0 (6.2) \\
        \bottomrule
      \end{tabular}
    \end{tikzfigure}
  } 
